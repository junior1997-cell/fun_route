<?php
  ...
  class Paquete
  {
    ...
    public function mostrar_detalle($idpaquete) {
      ...
      $paquete = [
        'idpaquete'             => empty($datospaquete['data']) ? '' : $datospaquete['data']['idpaquete'],
        'nombre'                => empty($datospaquete['data']) ? '' : $datospaquete['data']['nombre'],
        'cant_dias'             => empty($datospaquete['data']) ? '' : $datospaquete['data']['cant_dias'],
        'cant_noches'           => empty($datospaquete['data']) ? '' : $datospaquete['data']['cant_noches'],
        'alimentacion'          => empty($datospaquete['data']) ? '' : $datospaquete['data']['alimentacion'],
        'alojamiento'           => empty($datospaquete['data']) ? '' : $datospaquete['data']['alojamiento'],

        'descripcion'           => empty($datospaquete['data']) ? '' : $datospaquete['data']['descripcion'],
        'imagen'                => empty($datospaquete['data']) ? '' : $datospaquete['data']['imagen'],
        'incluye'               => empty($datospaquete['data']) ? '' : $datospaquete['data']['incluye'],
        'no_incluye'            => empty($datospaquete['data']) ? '' : $datospaquete['data']['no_incluye'],
        'recomendaciones'       => empty($datospaquete['data']) ? '' : $datospaquete['data']['recomendaciones'],
        'mapa'                  => empty($datospaquete['data']) ? '' : $datospaquete['data']['mapa'],
        'costo'                 => empty($datospaquete['data']) ? '' : $datospaquete['data']['costo'],
        'estado_descuento'      => empty($datospaquete['data']) ? '' : $datospaquete['data']['estado_descuento'],

        'porcentaje_descuento'  => empty($datospaquete['data']) ? '' : $datospaquete['data']['porcentaje_descuento'],
        'monto_descuento'       => empty($datospaquete['data']) ? '' : $datospaquete['data']['monto_descuento'],
        'resumen'               => empty($datospaquete['data']) ? '' : $datospaquete['data']['resumen'],
        'desc_alojamiento'      => empty($datospaquete['data']) ? '' : $datospaquete['data']['desc_alojamiento'],
        'desc_comida'           => empty($datospaquete['data']) ? '' : $datospaquete['data']['desc_comida'],
    ...
    public function mostrar_hoteles(){
      $sql_1 = "SELECT * FROM hoteles as h WHERE h.estado = '1' AND h.estado_delete = '1' order by estrellas desc;";
