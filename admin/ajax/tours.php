          ...
          if ($rspta['status'] == true) {
            ...
            foreach ($rspta['data'] as $key => $value) {        
              ...
              $data[]=array(
                ...
                "6"=>$estado_descuento,
                "7"=>'<button class="btn btn-info btn-sm" onclick="galeria(' . $value['idtours'] .')" data-toggle="tooltip" data-original-title="Ver detalle compra"><i class="fa fa-eye"></i></button>',
              );
            }
            $results = array(
