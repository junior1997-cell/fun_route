<?php
  ...
  if (!isset($_SESSION["nombre"])) {
    ...
    if ($_SESSION['venta_abono'] == 1) {
      ...
      $resumen_producto = new ResumenVentaProducto($_SESSION['idusuario']);
        ...
        case 'tbla_facturas':
          ...
          if ($rspta['status']) {
            ...
            foreach ($rspta['data'] as $key => $reg) {
              ...
              $data[] = [    
                "0" => $cont++,
                "1" => '<button class="btn btn-info btn-sm" onclick="ver_detalle_ventas(' . $reg['idventa_producto'] .', '. $reg['idproducto'] . ')" data-toggle="tooltip" data-original-title="Ver detalle compra"><i class="fa fa-eye"></i></button>' . $toltip ,
