<?php 
  ...
  $hojaActiva->setCellValue('I3', $rspta['data']['compra']['val_igv']);
  $hojaActiva->setCellValue('K1', $rspta['data']['compra']['tipo_comprobante']);
  $hojaActiva->setCellValue('K2', $rspta['data']['compra']['serie_comprobante']);
  ...
  $hojaActiva->setCellValue('J'.($fila_1), $rspta['data']['compra']['tipo_gravada']);
  $hojaActiva->setCellValue('J'.($fila_1 + 1), "IGV(".( ( empty($rspta['data']['compra']['val_igv']) ? 0 : floatval($rspta['data']['compra']['val_igv']) )  * 100 )."%)");
  $hojaActiva->setCellValue('J'.($fila_1 + 2), "TOTAL");

  $hojaActiva->setCellValue('K'.($fila_1), number_format($rspta['data']['compra']['subtotal'], 2, '.',',') );
  $hojaActiva->setCellValue('K'.($fila_1 + 1), number_format($rspta['data']['compra']['igv'], 2, '.',',') );
  $hojaActiva->setCellValue('K'.($fila_1 + 2), number_format($rspta['data']['compra']['total'], 2, '.',','));
