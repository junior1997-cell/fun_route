  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="en">
      <head>
        ...
        <title>Reporte venta paquete | Admin Fun Route</title>

        <?php $title = "Reporte venta paquete"; require 'head.php'; ?>
      ...
      <body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed">
        ...
        <script type="text/javascript" src="scripts/chart_venta_paquete.js"></script>         
