...
<html lang="es">
  <head>
    ...
    <?php $title = "Tours"; require 'head.php'; ?>
                ...
                <div class="card card-primary card-outline">
                  <div class="card-header">
                    <h3 class="card-title btn-regresar" style="display: none;">
                      <button type="button" class="btn bg-gradient-warning" onclick="limpiar_tours(); show_hide_form(1);"><i class="fas fa-arrow-left"></i> Regresar</button>
                    </h3>
                    <h3 class="card-title btn-agregar">
                      ...
                      Administra de manera eficiente tus Tours.
                    </h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
