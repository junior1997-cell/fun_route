...
function listar_unidades_m() {
  ...
  tabla_unidades_m=$('#tabla-unidades-m').dataTable({
    ...
    buttons: [      
      { text: '<i class="fa-solid fa-arrows-rotate" data-toggle="tooltip" data-original-title="Recargar"></i>', className: "btn bg-gradient-info", action: function ( e, dt, node, config ) { tabla_unidades_m.ajax.reload(null, false); toastr_success('Exito!!', 'Actualizando tabla', 400); } },
