...
function tbla_principal() {
  tabla_itinerario = $("#tabla-itinerario").dataTable({
    ...
    buttons: [      
      { text: '<i class="fa-solid fa-arrows-rotate" data-toggle="tooltip" data-original-title="Recargar"></i>', className: "btn bg-gradient-info", action: function ( e, dt, node, config ) { tabla_itinerario.ajax.reload(null, false); toastr_success('Exito!!', 'Actualizando tabla', 400); } },
