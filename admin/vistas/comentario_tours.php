  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      ...
      <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed">
          ...
          if ($_SESSION['otro_ingreso']==1){
            ...
            <div class="content-wrapper" >
              ...
              <section class="content">
                      ...
                      <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                          ...
                          <div id="mostrar-tabla">
                            <table id="tabla-comentario_tours" class="table table-bordered table-striped display" style="width: 100% !important;">
                              <thead>
                                <tr>
                ...
                <div class="modal fade" id="modal-comentario_tours">
                      ...
                      <div class="modal-body">
                        ...
                        <form id="form-paquete" name="form-paquete" method="POST">
                          <div class="card-body row">                               
                            ...
                            <!-- id paquete -->
                            <input type="hidden" name="idcomentario_tours" id="idcomentario_tours" />
                            <!-- Nombre del tours -->
                            <div class="col-lg-10">
                              <div class="form-group">
                                <label for="nombre_tours">Nombre Tours</label>
                                <input type="text" name="idtours" class="form-control" id="idtours" placeholder="Nombre-tours" />
                              </div>
                            </div>
                          ...
                          <!-- /.card-body -->
                          <button type="submit" style="display: none;" id="submit-form-comentario_tours">Submit</button>
                        </form>
                      </div>
        ...
        <script type="text/javascript" src="scripts/comentario_tours.js"></script>
