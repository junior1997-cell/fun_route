...
var FullCalendar = (function (e) {
    ...
    function k(e, t, n, r, o) {
      ...
      if ((o && "className" == t && (t = "class"), "style" === t))
        ...
        "o" === t[0] && "n" === t[1]
          ? ((i = t !== (t = t.replace(/Capture$/, ""))), (a = t.toLowerCase()) in e && (t = a), (t = t.slice(2)), e.l || (e.l = {}), (e.l[t + i] = n), (s = i ? x : M), n ? r || e.addEventListener(t, s, i) : e.removeEventListener(t, s, i))
    ...
    function N(e, t, n, r, o, i, a, s) {
      ...
      if (null === t.type) v === g || (s && e.data === g) || (e.data = g);
        ...
        (function (e, t, n, r, o) {
          ...
          s ||
            ("value" in g && void 0 !== (l = g.value) && (l !== e.value || ("progress" === t.type && !l)) && k(e, "value", l, v.value, !1), "checked" in g && void 0 !== (l = g.checked) && l !== e.checked && k(e, "checked", l, v.checked, !1));
      }
      return e;
    }
    function H(e, t, n) {
    ...
    var ve = ['dom', 'lun', 'mar', 'mié', 'jue', 'vie', 'dom'];
    function ge(e, t) {
      var n = xe(e);
      return (n[2] += 7 * t), _e(n);
    }
    ...
    function Jt(e, t, n, o, i, a) {
      for (
        var s = { title: e.title || "", groupId: e.groupId || "", publicId: e.id || "", url: e.url || "", recurringDef: null, defId: ee(), sourceId: n, allDay: o, hasEnd: i, ui: zt(e, a), extendedProps: r(r({}, e.extendedProps || {}), t) },
          l = 0,
        ...
        g &&
          ("inverse-background" === f.display
            ? S.groupId
              ? o[S.groupId].push(g)
              : i[p.defId].push(g)
            : "none" !== f.display && ("background" === f.display ? s : l).push({ def: S, ui: f, instance: p, range: g, isStart: v.start && v.start.valueOf() === g.start.valueOf(), isEnd: v.end && v.end.valueOf() === g.end.valueOf() }));
      }
      for (var m in o)
          ...
          (e.prototype.setDates = function (e, t, n) {
            ...
            if (l && (null == t || (r = a.createMarker(t))) && this._instance) {
              ...
              if (r) {
                ...
                (i = d),
                  (o = c).years === i.years && o.months === i.months && o.days === i.days && o.milliseconds === i.milliseconds ? this.mutate({ datesDelta: c, standardProps: s }) : this.mutate({ startDelta: c, endDelta: d, standardProps: s });
    ...
    var na = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          for (
            var e, t = this.props, n = this.state, r = this.context, i = t.sections || [], a = this.processCols(t.cols), s = this.renderMicroColGroup(a, n.shrinkWidth), l = Ji(t.liquid, r), u = i.length, c = 0, d = [], p = [], f = [];
          ...
          (t.prototype.renderSimpleLayout = function (e, t, n) {
            ...
            return (
              ...
              t &&
                ...
                i.push({ type: "body", key: "all-day-divider", outerContent: Ar("tr", { className: "fc-scrollgrid-section" }, Ar("td", { className: "fc-timegrid-divider " + r.theme.getClass("tableCellShaded") })) })),
