          ...
          (this.$wrapper = g('<div>', {
            class: function () {
              ...
              return (
                ...
                o.map(l._getClass.bind(l)).concat([l.options.baseClass], l._getClasses(l.options.wrapperClass)).join(" ")
                 
              );
            } 
             
          })),
          (this.$container = g("<div id='holaaa' >", { class: this._getClass("container") })),
        ...
        f(j, [
          ...
          },
          {
            ...
            value: function (l, m) {
              return "undefined" == typeof l
                ? this.options.state
                : this.options.disabled || this.options.readonly || (this.options.state && !this.options.radioAllOff && this.$element.is(":radio"))
                ? this.$element
                : (this.$element.is(":radio") ? g('[name="' + this.$element.attr("name") + '"]').trigger("setPreviousOptions.bootstrapSwitch") : this.$element.trigger("setPreviousOptions.bootstrapSwitch"),
          ...
          },
          {
            ...
            value: function (l) {
              return "undefined" == typeof l
                ? this.options.size
                : (null != this.options.size && this.$wrapper.removeClass(this._getClass(this.options.size)), l && this.$wrapper.addClass(this._getClass(l)), this._width(), this._containerPosition(), (this.options.size = l), this.$element);
            },
          },
          {
            key: "animate",
          ...
          },
          {
            ...
            value: function (l) {
              return "undefined" == typeof l
                ...
                : (this.options.offColor && this.$off.removeClass(this._getClass(this.options.offColor)), this.$off.addClass(this._getClass(l)), (this.options.offColor = l), this.$element);
            },
          },
          {
            key: "onText",
              ...
              this.$label.on({
                ...
                "mousedown.bootstrapSwitch touchstart.bootstrapSwitch": function (o) {
                  l._dragStart ||
                    ...
                    (o.preventDefault(),
                    o.stopPropagation(),
                    (l._dragStart = (o.pageX || o.originalEvent.touches[0].pageX) - parseInt(l.$container.css("margin-left"), 10)),
